        ...
        >
            ...
            <div className="projects__navbar">
                <div className={active === 'All' && 'projects__navbar-active'} onClick={
                    ...
                    <div className={active === 'webdev' && 'projects__navbar-active'} onClick={() => handleFilterCategory('webdev')}>Web Dev</div>
                    ...
                    <div className={active === 'flask' && 'projects__navbar-active'} onClick={() => handleFilterCategory('flask')}>Flask</div>
